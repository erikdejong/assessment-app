...
class DocAnalyzerAgent:
    ...
    async def process_message(self, message: str, success_criteria: str, history: List[Any], thread: str) -> List[Any]:
        """
    ...
    def _build_graph(self):
        ...
        graph_builder.add_conditional_edges("evaluator", self._route_based_on_evaluation, {"worker": "worker", "END": END})
